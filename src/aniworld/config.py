...
DEFAULT_CONFIG = {
    ...
    "general": {
        # Standardaktion (Download, Watch, Syncplay)
        "action": "Download",
        "download_path": "/mnt/Plex",     # Standardpfad für Downloads
        # Standardsprache (German Dub, English Sub, German Sub)
        "language": "German Dub",
        ...
        # Pfad zur Logdatei
        "log_file_path": os.path.join(os.path.expanduser('~'), "aniworld.log"),
    },
...
# Hilfsfunktionen, um leichter auf häufig verwendete
# Konfigurationseinstellungen zuzugreifen
...
def get_terminal_size() -> Tuple[int, int]:
    ...
    return (
        size[0],
        size[1]) if isinstance(
        size,
        list) and len(size) == 2 else (
            90,
        38)
